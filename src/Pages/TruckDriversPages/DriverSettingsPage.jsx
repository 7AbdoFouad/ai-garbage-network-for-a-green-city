  ...
  useEffect(() => {
    setUserData({
      ...
      numOfAcceptedAnnouncementsCount:
        TruckDriver.numOfAcceptedAnnouncementsCount || 0,
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.stats}>
        ...
        <p>
          📌 عدد المهام التي اتممتها:{" "}
          <strong>{userData.numberOfCompletedTasks}</strong>
        </p>
        <p>
          📌 عدد الاستطلاعات التي اكملتها:{" "}
