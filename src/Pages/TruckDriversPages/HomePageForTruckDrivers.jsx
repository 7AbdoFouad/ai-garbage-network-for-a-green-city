...
import styles from '../ManagerPages/HomeManager.module.css'; // Assuming the styles are similar for both pages
    ...
    <div className={styles.homeContainer}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          <h1 className={styles.heroTitle}>Welcome to Our Green Community Truck Driver</h1>
